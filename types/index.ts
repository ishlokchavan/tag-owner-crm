...
export interface Note { id: string; owner_id: string; note: string; note_type: NoteType; created_at: string; agent_id?: string | null }
export interface Interaction { id: string; owner_id: string; interaction_type: InteractionType; outcome: InteractionOutcome | null; created_at: string; agent_id?: string | null }
