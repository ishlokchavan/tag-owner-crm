...
import { LayoutDashboard, Users, Phone, TrendingUp, BarChart2 } from 'lucide-react'
...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-[#141614] border-t border-[#252825] z-50">
